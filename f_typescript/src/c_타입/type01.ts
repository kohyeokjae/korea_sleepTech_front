...
// name = 30;
// anyData = 1234; - 타입을 명시하지 않아도 초기화 데이터로 타입 지정됨!
...
// : 직점적인 타입 명시를 하지 않을 경우 값이 할당되기 전까지 자동으로 any타입을 인식

//& 6. never 타입
// : 절대 발생하지 않는 값의 타입
// -함수가 예외를 발생시키너가, 끝나지 않을 때 사용
