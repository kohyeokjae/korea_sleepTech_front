...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function revealCardsTemporary() {
    ...
    completedButton.disabled = true; // disabled 속성: 해당 요소에 대한 컨트롤의 비활성화를 지정
  ...
  //! 변수 선언
  // 카드가 뒤집혔는지 여부
  let hasFlipppedCard = false; // 첫 번째 카드가 선택되지 않은 것이 기본값
  // 첫 번째, 두 번째 선택된 카드
  ...
  function flipCard() {
    ...
    if (!hasFlipppedCard) {
      ...
      hasFlipppedCard = false; // 다음 쌍의 선택을 위한 기본값 선언
      secondCard = this;
