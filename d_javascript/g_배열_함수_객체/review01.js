...
// - cpmpleted: 할 일의 완료 상태를 나타내는 boolean 데이터

/*
  Todo 객체 예시
  let todo = {
    id: 1,
    content: '정보처리기사 필기 원서 접수'
    completed: false
  }
*/
...
// 3) 할 일  삭제 함수
// : 삭제하고자하는 id를 지진 할 일을 todos 배열에서 저거
// > 배열 내부 요소 객수의 변환 O (filre)
function deleteTodo(id) {
  // 1, 2, 3, 4, 5중 4를 제거
  // 4와 일치하지 않는 1, 2, 3, 5만을 새로운 배열 저장
  // >> 4가 삭제된 효과
