...
class Library {
  ...
  updateBook(id, newTitle, newAuthor) {
    ...
    console.log(
      `책 (id: ${id}) 정보가 업데이트되었습니다 : 제목 - ${book.title}, 저자 - ${book.author}`
    );
  }
...
busanLibrary.addBook("sqld 공부는 재미있어", "홍길동");
busanLibrary.addBook("자바 공부는 재미있어", "고길동");
busanLibrary.addBook("자바 스크립트 공부는 재미있어", "홍길둥");
busanLibrary.addBook("HTML 공부는 재미있어", "고길동");
...
busanLibrary.updateBook(2, "자바 공부는 여려워", null);
busanLibrary.displayBooks();
...
busanLibrary.filterBooksByAuthor("고길동");
busanLibrary.filterBooksByTitle("자바");
