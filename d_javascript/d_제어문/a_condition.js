...
//! 2) switch case 문
// : 하나의 표현식 값을 확인하고 해당 값과 일치하는 case문의 코드 블록 실행

// switch 블록 내에 case 값들이 나열
// +) 어떤 case가 와도 일치하지 않을 경우 default문 실행
...
// 점수를 변수에 담아
// , 해당 점수가 0미만 100 초과일 경우 '유요한 점수가 아닙니다.'
...
console.log("===");
true || console.log("A"); // OR 연사자여서 true를 만나자마자 뒤에 있는 식을 읽지 않는다.
console.log("===");
true && console.log("A");
// =========================
