...
// - HTML5 웹 스토리지 사양의 일부 도입으로 '쿠키'의 공간을 제한을 보완한
//   저장 용량과 보안성을 제공
...
// cf) 로컬 스토리지에 객체나 배열 등의 참조 자료형 데이터 저자 시
//     : 문자열 형태로 변환
//     : JSON.stringfy()
...
if (keyValue || userAgeValue || usernameValue || userEmailValue) {
  console.log(keyValue); // value
  console.log(userAgeValue); // 20
  console.log(usernameValue); // 홍길동
