...
// >> 값 전달의 선택이 있을 경우, 무조건 값 할당이 필요한 데이터보다 뒤에 작성
function greet1(name = "비회원 고객", age) {
  console.log(`${name}님! ${age}세입니다.`);
}

greet1(50); // 50님! undefined세입니다.

function greet2(age, name = "비회원 고객") {
  console.log(`${name}님! ${age}세입니다.`);
}

greet2(50); // 비회원 고객님! 50세입니다.
greet2(30, "홍길동"); // 홍길동님! 30세입니다.

//! 2. 가변 매개변순: 함수 호출 시 인자 수의 고정 X, 함수 내에서 유동적으로 처리
...
print(1, 2); // []
print(1, 2, 3); // [3]
print(1, 2, 4, 6, 7); // [4, 6, 7]
print(1, 2, 4, 5, 6, 7, 9); // [4, 5, 6, 7, 9]
...
console.log(findMin(41, 23, 14, 15, 643, 734)); // 14