...
//& reduce()
// : 배열의 각 요소에 대해 함수를 적용하여 '단일 값 생성'

/*
  reduce 메서드의 인자값: 콜백 함수, 초기값(initialValue)
  ...
  ? cf) 배열명.map(function(a, b, c) {기능 작성});
*/
