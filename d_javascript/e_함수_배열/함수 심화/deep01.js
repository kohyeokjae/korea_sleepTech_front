...
console.log(funcType); // [Function: funcType]

//! 1. 콜백 함수(callback function)
// : 다른 함수의 인자로 전달, 그 함수의 내부에서 실행되는 함수

//! 2. 콜백 함수의 필요성(응용 사례)
// - 비동기 처리: 순차적인 코드 흐름을 개발자가 원하는 방식을 제어
...
function callback1(callbackFunc) {
  // callbackFunc 매개변수: 콜백 함수(다른 함수의 인자로 전달됨)
...
const print2 = function (count) {
  console.log(`${count}번재 함수 호출`);
};

callback1(print2); // print2(콜백 함수) 함수를 callback1(메인 로직)의 인자로 발달
...
const oddNumber = oddNumber => console.log(`${oddNumber}값은 홀수입니다.`);
