...
let hasPotato = snacks.includes("감자칩");
...
console.log(firtsFruit); // Apple

newLength = fruits.unshift("Mango", "Orange"); // 시박 부분에 하나 이상의 요소를 추가(,로 나열)
...
// 1) join('구분자'): 배열의 모든 요소를 연경하여 하나의 문자열로 반환
