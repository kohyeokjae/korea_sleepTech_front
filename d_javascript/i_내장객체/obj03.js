...
console.log(`0 이상 1 미만의 나수 생성: ${Math.random()}`);
console.log(`0 이상 N 미만의 나수 생성: ${Math.random() * 10}`);
...
// 현재 날짜와 사간 반환
let now = new Date();
console.log(now); // 2025-03-18T06:42:31.220Z // 그리니치 천문대 시간 (우리나라: + 9H)

// getDate(): 현재 '일' (1 ~ 31)
// getDay(): 현재 '요일' (일요일 0~ 토요릴 6)
...
console.log(now.toLocaleTimeString()); // 오후 3:49:31