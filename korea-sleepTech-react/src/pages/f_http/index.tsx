...
// - 클라이언트(브라우저)와 서버(백엔트)가 서로 데이터를 주고 받는 방식
// >> 요청과(Request)과 응답(Response)의 형태로 데이터가 교환
