...
/*
  ...
  - @(기본 URL 설정)를 사용한 절대 경로 사용을 권장!
    >> vite.config.ts 와  tsconfig.json 파일에 각각 경로 지정 필수!
  ...
  : rfc, rfce 스니팻 사용 시
    ...
    cf) index.tsx 파일명: 폴더명을 활용한 import를 위함
        >> 내부의 함수명은 대문자로 수정: 외부에서 인식 간으한 컴포턴트가 생성
*/
...
export function Img() {
  ...
  // tsx의 "함수형" 컴포넌는 return 시 HTML을 반환
  return (
    <div>
      {/* 
