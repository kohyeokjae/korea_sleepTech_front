...
/*
  ...
  - props로 전달된 데이터는 자식 컴포넌트에서 readonldy! 처럼 사용
    (변경 불가 데이터)
*/
...
function MultiProps({ name = "구길동", colorProps }: MultiPropsType) {
  // 여러 개의 props가 전달되더라도 하나의 객체로 전달
  ...
  return (
    <div>
      ...
      */}
      ...
      {/* 여러 개의 props 전달 */}
      <MultiProps name="고길동" colorProps="lightblue" />
