...
//# vite를 사용한 리엑트 프로젝트 생성

//? cf) npm 7+
// npm create vite@latest

//! 프로젝트 설정 순서 (터미널에서 대화형으로 진행)
// project name: 프로젝트 폴터명
// Package name: package.json의 "name"의 속성값으로 지정 (소문자로 작성!!)
...
// cf) 핫 리로딩: 앱을 처음부터 다시 실행하지 않고
//     , 새로운 코드 변경에 따른 해당 변경 사항만 반영하는 기능
...
// : npm install 
// 2. Permission denied(Mac OS)
// : 명령어 앞에 sudo 추기 || 권한 설정 확인
...
/*
  {
    ...
    "devDependencies": { //! 애플리케이션 동작과는 무관하지만 개발 시 필요한 의존성 라이브러리
      "@eslint/js": "^9.21.0",
      "@types/react": "^19.0.10", //? TypeScript용 리액트 타입 저의
...
/*
  ...
  export default defineConfig({
    ...
    resolve: {
      alias: {
        '@': path.resolve(__dirname, './src'), // @ 기호를 scr 폴더로 인식
      }
    }
  })
*/
